...
@section('content')
    @php
        if ($getParlamentar) {
            $getParlamentar->dsc_casa == 'Câmara dos Deputados' ? ($valueDefaultCodInterlocutor = 'b06ae9a4-385b-4a50-8181-e30d630af5a4') : ($valueDefaultCodInterlocutor = 'b06ae9a4-385b-4a50-8181-e30d630af5b4');
    ...
    <div class="row" id="divContent" style="display: none;">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left collapse"
                            ...
                            <div class="alert alert-success alert-dismissible d-flex align-items-center mb-3 fade show"
                                ...
                                <div>
                                    O sistema gravou com sucesso a alteração feita na parde de detalhes do atendimento.
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-2 text-left">
                            ...
                            {!! app(App\Http\Controllers\TabAtendimentosController::class)->modalTabelaLog(
                                'DetalheAtendimento',
                                'Ações realizadas no(a) Detalhes do atendimento',
                                    ...
                                    <div id="div_{!! $columnName !!}"
                                        ...
                                        @if ($data_type === 'uuid')
                                            @if ($columnName === 'cod_assunto')
                                                {!! Form::select('atendimento[' . $columnName . ']', ${$columnName . '_pluck'}, $atendimento->$columnName, [
                                                    'class' => 'form-control text-dark',
                                                    'style' => 'cursor: pointer; width: 100% !Important;',
                                                    'id' => $columnName,
                                                    'autocomplete' => 'off',
                                                    'placeholder' => 'Selecione',
                                                    'onchange' => "javascript: atualizar_input_select(this.id, this.value, '$codAtendimento', 'atendimento')",
                                                    'required' => 'required',
                                                ]) !!}
                                        ...
                                        @if ($data_type === 'date')
                                            {!! Form::date('atendimento[' . $columnName . ']', $atendimento->$columnName, [
                                            ...
                                            @if ($columnName === 'bln_representante')
                                                {!! Form::select(
                                                    ...
                                                    [
                                                        ...
                                                        'placeholder' => 'Selecione',
                                                        'required' => 'required',
                                                        'onchange' => "javascript: if(this.value == 'Sim') { document.getElementById('div_nom_representante').style.display = 'block'; document.getElementById('div_dsc_cargo_representante').style.display = 'block'; } else { document.getElementById('div_nom_representante').style.display = 'none'; document.getElementById('nom_representante').value = ''; document.getElementById('div_dsc_cargo_representante').style.display = 'none'; document.getElementById('dsc_cargo_representante').value = ''; } atualizar_input_select(this.id, this.value, '$codAtendimento', 'atendimento');",
                                                    ],
                                                ) !!}
                                            @else
                                                {!! Form::text('atendimento[' . $columnName . ']', $atendimento->$columnName, [
                                                    'class' => 'form-control text-dark',
                                                    'id' => $columnName,
                                                    'placeholder' => 'Digite o(a) ' . nomeCampoNormalizadoTabAtendimento($columnName),
                                                    'onchange' => "javascript: atualizar_input_text(this.id, this.value, '$codAtendimento', 'atendimento')",
                                                    'autocomplete' => 'off',
                                                ]) !!}
                                            @endif
                                        @endif
                                        ...
                                        @if ($data_type === 'text')
                                            {!! Form::textarea('atendimento[' . $columnName . ']', $atendimento->$columnName, [
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 mb-4 mt-4 pt-2 text-left">
                            ...
                            <div class="modal" id="modalConfirmarExclusaoAtendimento_{{ $codAtendimento }}" tabindex="-1"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-danger btn-sm"
                                                onclick="javascript: excluir_atendimento('{{ $codAtendimento }}');"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left collapse"
                            id="divColRetorno_incluir_convidado">
                            <div class="alert alert-success alert-dismissible d-flex align-items-center mb-3 fade show"
                                role="alert">
                                <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img"
                                    aria-label="Success:">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left collapse"
                            id="divColRetorno_excluir_convidado">
                            <div class="alert alert-success alert-dismissible d-flex align-items-center mb-3 fade show"
                                role="alert">
                                <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img"
                                    aria-label="Success:">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-1 text-left">
                            ...
                            <div class="row form-group multiple-form-group input-group pt-2">
                                ...
                                <div class="col-1 col-sm-1 col-md-1 col-lg-1 mb-4 pb-4 text-left"
                                    style="padding-top: 2.7rem !Important; padding-left: 0rem !Important;">
                            ...
                            <div class="row">
                                ...
                                @foreach ($atendimento->convidados as $convidado)
                                    ...
                                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 mb-4 text-left">
                                        ...
                                        {!! Form::select('convidado[cod_interlocutor][]', ${'cod_interlocutor_pluck'}, $convidado->cod_interlocutor, [
                                            'class' => 'form-control text-dark',
                                            'style' => 'cursor: pointer; width: 100% !Important;',
                                            'id' => 'cod_interlocutor_convidado',
                                            'autocomplete' => 'off',
                                            'onchange' => "javascript: atualizar_input_select('cod_interlocutor', this.value, '$convidado->cod_convidado', 'convidado')",
                                            'placeholder' => 'Selecione',
                                        ]) !!}

                                    </div>

                                    <div class="col-11 col-sm-5 col-md-6 col-lg-6 text-left">

                                        <label for="" class="form-label">Nome convidado(a)</label>

                                        {!! Form::text('convidado[nom_convidado][]', $convidado->nom_convidado, [
                                            'class' => 'form-control text-dark',
                                            'id' => 'nom_convidado',
                                            'placeholder' => 'Digite o nome do(a) convidado(a)',
                                            'onchange' => "javascript: atualizar_input_text(this.id, this.value, '$convidado->cod_convidado', 'convidado')",
                                            'autocomplete' => 'off',
                                        ]) !!}
                                    ...
                                    <div id="buttonsFileAddRemove"
                                        class="col-1 col-sm-1 col-md-1 col-lg-1 mb-4 pb-4 text-left"
                                        style="padding-top: 2.7rem !Important; padding-left: 0rem !Important;">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left collapse"
                            id="divColRetorno_incluir_demandas">
                            <div class="alert alert-success alert-dismissible d-flex align-items-center mb-3 fade show"
                                role="alert">
                                <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img"
                                    aria-label="Success:">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left collapse"
                            id="divColRetorno_excluir_demandas">
                            <div class="alert alert-success alert-dismissible d-flex align-items-center mb-3 fade show"
                                role="alert">
                                <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img"
                                    aria-label="Success:">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-1 text-left">
                            ...
                            <div class="row form-group multiple-form-group input-group pt-2">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4 text-left">
                                    ...
                                    <label for="{!! $columnName !!}" class="form-label">Prazo estimado de conclusão
                                        da
                                        demanda</label>
                            ...
                            <div class="row">
                                ...
                                @foreach ($atendimento->demandas as $demanda)
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4 text-left">
                                        ...
                                        {!! Form::textarea('demadas[dsc_demanda][]', $demanda->dsc_demanda, [
                                            'class' => 'form-control',
                                            'rows' => 1,
                                            'id' => 'dsc_demanda',
                                            'placeholder' => 'Digite a descrição da demanda',
                                            'rows' => 2,
                                            'cols' => 50,
                                            'onchange' => "javascript: atualizar_input_text('dsc_demanda', this.value, '$demanda->cod_demanda_atendimento', 'demadas')",
                                        ]) !!}
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4 text-left">
                                        ...
                                        {!! Form::select('demadas[codigoUnidade][]', $responsaveisDemanda, $demanda->codigoUnidade, [
                                            'id' => 'codigoUnidade',
                                            'class' => 'form-control',
                                            'style' => 'cursor: pointer;',
                                            'placeholder' => 'Selecione',
                                            'onchange' => "javascript: atualizar_input_select('codigoUnidade', this.value, '$demanda->cod_demanda_atendimento', 'demadas')",
                                        ]) !!}
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4 text-left">
                                        ...
                                        {!! Form::date('demadas[dte_prazo][]', $demanda->dte_prazo, [
                                            'class' => 'form-control text-dark text-right font-numero date',
                                            'id' => 'dte_prazo',
                                            'style' => 'cursor: pointer',
                                            'autocomplete' => 'off',
                                            'onchange' => "javascript: atualizar_input_select('dte_prazo', this.value, '$demanda->cod_demanda_atendimento', 'demadas')",
                                        ]) !!}
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2 mb-4 text-left">
                                        ...
                                        {!! Form::select('demadas[cod_status_demanda][]', $statusDemanda, $demanda->cod_status_demanda, [
                                            'id' => 'cod_status_demanda',
                                            'class' => 'form-control',
                                            'style' => 'cursor: pointer;',
                                            'onchange' => "javascript: atualizar_input_select('cod_status_demanda', this.value, '$demanda->cod_demanda_atendimento', 'demadas')",
                                        ]) !!}
        ...
        <div class="modal" id="modalLocalAlerta" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
