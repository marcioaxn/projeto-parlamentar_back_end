<div class="modal fade" id="modalAdicionarItensOrcamentariosFinanceiros{{ $acaoOrcamentaria }}" tabindex="-1"
    aria-labelledby="modalAdicionarItensOrcamentariosFinanceirosLabel" aria-hidden="true"
    style="padding-top: 81px!Important;">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <p class="modal-title" id="modalAdicionarItensOrcamentariosFinanceirosLabel{{ $acaoOrcamentaria }}"></p>
            </div>
            <div class="modal-body">

                <div class="row">

                    {!! Form::hidden('dsc_tipo_item_orcamentario_financeiro', null, [
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2 col-xl-2 col-xxl-2 mb-4"
                        id="divNumMes{{ $acaoOrcamentaria }}" style="display: none;">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-xl-3 col-xxl-3 mb-4"
                        id="divNumRp{{ $acaoOrcamentaria }}" style="display: none;">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-4"
                        id="divLegendaRp{{ $acaoOrcamentaria }}" style="display: none;">
