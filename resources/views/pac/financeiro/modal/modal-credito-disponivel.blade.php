<div class="modal fade" id="modalAdicionarCreditoDisponivel{{ $acaoOrcamentaria }}" tabindex="-1"
    aria-labelledby="modalAdicionarCreditoDisponivelLabel" aria-hidden="true" style="padding-top: 100px!Important;">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header" style="background: linear-gradient(135deg,#a97b93 0%, #c27ba0 100%);color: white;">
                <p class="modal-title text-white" id="modalAdicionarCreditoDisponivelLabel">Cadastrar
                    Crédito Disponível para {{ $acaoOrcamentaria }}</p>
            </div>
            <div class="modal-body">

                <div class="row">

                    {!! Form::hidden('dsc_tipo_item_orcamentario_financeiro', 'Crédito Disponível (Não Empenhado)', [
