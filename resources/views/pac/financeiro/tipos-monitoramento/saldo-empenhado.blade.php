<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 font-numero mb-2">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3 text-right">
                <span class="" data-bs-toggle="modal"
                    data-bs-target="#modalAdicionarItensOrcamentariosFinanceiros{{ $acaoOrcamentaria }}" style="cursor: pointer;" onclick="javascript: atualizarModal('Saldo Empenhado', '{{ $acaoOrcamentaria }}')"><i
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tbody>
                @foreach ($novoPac->evolucaoSaldoEmpenhado as $valueItem)
                    @if ($valueItem->cod_acao_orcamentaria === $acaoOrcamentaria)
                        ...
                        <tr>
                            ...
                            <th class="text-right p-1" style="font-size: 0.95rem!Important; background-color: #e9f1f7;">
