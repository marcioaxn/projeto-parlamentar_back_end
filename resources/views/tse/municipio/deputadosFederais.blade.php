                ...
                <tbody>
                    ...
                    @if ($tseDeputadosFederais)
                        ...
                        @foreach ($tseDeputadosFederais as $key => $value)
                            <tr>
                                <th class="<?php $value->parlamentarExeercicio ? print 'bg-tr-camara' : ''; ?> text-center font-numero"
                                    style="width: 3%!Important; {!! $value->parlamentarExeercicio
                                        ? 'background-color: #e4ece8 !Important; color: #000000 !Important;'
                                        : '' !!}">
                                    {!! $contTse !!}
                                </th>
                                <th class="<?php $value->parlamentarExeercicio ? print 'bg-tr-camara' : ''; ?>" style="width: 14%!Important; {!! $value->parlamentarExeercicio
                                    ? 'background-color: #e4ece8 !Important; color: #000000 !Important;'
                                    : '' !!}">

                                    @if ($value->parlamentarExeercicio)
                                        <a class="text-dark" href="{!! url('parlamentar/' . $value->parlamentarExeercicio->cod_parlamentar) !!}" target="_blank"
                                ...
                                <th class="<?php $value->parlamentarExeercicio ? print 'bg-tr-camara' : ''; ?>" style="width: 12%!Important; {!! $value->parlamentarExeercicio
                                    ? 'background-color: #e4ece8 !Important; color: #000000 !Important;'
                                    : '' !!}">
                                    ...
                                    @php
                                        ...
                                        if ($value->parlamentarExeercicio) {
                                            $sglPartidoAtual = $value->parlamentarExeercicio->sgl_partido;
                                ...
                                <th class="<?php $value->parlamentarExeercicio ? print 'bg-tr-camara' : ''; ?>" style="width: 10%!Important; {!! $value->parlamentarExeercicio
                                    ? 'background-color: #e4ece8 !Important; color: #000000 !Important;'
                                    : '' !!}">
                                ...
                                <th class="<?php $value->parlamentarExeercicio ? print 'bg-tr-camara' : ''; ?>" style="width: 8%!Important; {!! $value->parlamentarExeercicio
                                    ? 'background-color: #e4ece8 !Important; color: #000000 !Important;'
                                    : '' !!}">
                                ...
                                <th class="<?php $value->parlamentarExeercicio ? print 'bg-tr-camara' : ''; ?> text-right"
                                    style="width: 12%!Important; {!! $value->parlamentarExeercicio
                                        ? 'background-color: #e4ece8 !Important; color: #000000 !Important;'
                                        : '' !!}">

                                    {!! '<span class="font-numero">' . formatarNumeroInteiro($value->qt_votos_nominais) . '</span>' !!}
                                ...
                                <th class="<?php $value->parlamentarExeercicio ? print 'bg-tr-camara' : ''; ?> text-right"
                                    style="width: 12%!Important; {!! $value->parlamentarExeercicio
                                        ...
                                        : '' !!}">
                                    @php
                                        $value->qt_votos_total > 0
                                            ? ($prcVotos = ($value->qt_votos_nominais / $value->qt_votos_total) * 100)
                                            : ($prcVotos = 0);
                                    @endphp

                                    <span class="<?php $value->parlamentarExeercicio ? print 'bg-tr-camara' : ''; ?>" style="">{!! '<span class="font-numero">' . converteValor('MYSQL', 'PTBR', $prcVotos) . '</span>%' !!}</span>
