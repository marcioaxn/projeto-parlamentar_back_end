                        ...
                        @foreach ($tseSenadores as $key => $value)
                            <tr>
                                <th class="{!! $value->dsc_situacao_tp === 'Exercício' ? 'bg-tr-senado' : '' !!} text-center font-numero"
                                    style="width: 3%!Important; {!! $value->dsc_situacao_tp === 'Exercício' ? 'background-color: #e2ecf3 !Important; color: #000000 !Important;' : '' !!}">
                                    {!! $contTse !!}
                                </th>
                                <th class="{!! $value->dsc_situacao_tp === 'Exercício' ? 'bg-tr-senado' : '' !!}" style="width: 25%!Important; {!! $value->dsc_situacao_tp === 'Exercício' ? 'background-color: #e2ecf3 !Important; color: #000000 !Important;' : '' !!}">
                                    ...
                                    @if (isset($value->cod_parlamentar) && !is_null($value->cod_parlamentar) && $value->cod_parlamentar != '')
                                        <a class="text-dark" href="{!! url('parlamentar/' . $value->cod_parlamentar) !!}" target="_blank"
                                            ...
                                            {!! $value->ds_cargo === 'Senador' || $value->ds_cargo === 'SENADOR' ? $value->nm_urna_candidato : $value->nom_parlamentar_sem_formatacao !!}
                                        </a>
                                    @else
                                        {!! $value->ds_cargo === 'Senador' || $value->ds_cargo === 'SENADOR' ? $value->nm_urna_candidato : $value->nm_candidato !!}
                                    @endif

                                </th>
                                <th class="{!! $value->dsc_situacao_tp === 'Exercício' ? 'bg-tr-senado' : '' !!}" style="width: 12%!Important; {!! $value->dsc_situacao_tp === 'Exercício' ? 'background-color: #e2ecf3 !Important; color: #000000 !Important;' : '' !!}">
                                ...
                                <th class="{!! $value->dsc_situacao_tp === 'Exercício' ? 'bg-tr-senado' : '' !!} text-right" style="width: 12%!Important; {!! $value->dsc_situacao_tp === 'Exercício' ? 'background-color: #e2ecf3 !Important; color: #000000 !Important;' : '' !!}">

                                    @php
                                        if ($value->ds_cargo === 'Senador' || $value->ds_cargo === 'SENADOR') {
                                            print '<span class="font-numero">' . formatarNumeroInteiro($value->qt_votos_nominais) . '</span>';
                                        }
                                    @endphp
                                ...
                                <th class="{!! $value->dsc_situacao_tp === 'Exercício' ? 'bg-tr-senado' : '' !!} text-right" style="width: 12%!Important; {!! $value->dsc_situacao_tp === 'Exercício' ? 'background-color: #e2ecf3 !Important; color: #000000 !Important;' : '' !!}">
                                    @php
                                        $value->qt_votos_total > 0 ? ($prcVotos = ($value->qt_votos_nominais / $value->qt_votos_total) * 100) : ($prcVotos = 0);
                                    @endphp

                                    {!! $value->ds_cargo === 'Senador' || $value->ds_cargo === 'SENADOR'
                                        ? '<span class="font-numero">' . converteValor('MYSQL', 'PTBR', $prcVotos) . '</span>%'
                                        : '' !!}
