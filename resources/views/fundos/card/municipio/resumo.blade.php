                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th class="borda_table_indicadores text-right font-numero"
                                ...
                                {!! formatarNumeroInteiro($fundoResumoMunicipio->num_quantidade_carteira_2023) !!}
                            </th>
                            <th class="borda_table_indicadores text-right font-numero"
                                style="width: 32.65%; font-size: 0.8rem !Important;">
                                {!! prettify_numbers($fundoResumoMunicipio->vlr_saldo_carteira_2023) !!}
                            </th>
                            <th class="borda_table_indicadores text-right font-numero"
                                style="width: 32.65%; font-size: 0.8rem !Important;">
                                {!! converteValor('MYSQL', 'PTBR', $fundoResumoMunicipio->prc_inadiplencia_2023) . '%' !!}
                            </th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <th class="borda_table_indicadores text-right font-numero"
                                ...
                                {!! formatarNumeroInteiro($fundoResumoMunicipio->num_quantidade_carteira_2024) !!}

                            </th>
                            <th class="borda_table_indicadores text-right font-numero"
                                style="font-size: 0.8rem !Important;">
                                {!! prettify_numbers($fundoResumoMunicipio->vlr_saldo_carteira_2024) !!}
                            </th>
                            <th class="borda_table_indicadores text-right font-numero"
                                style="font-size: 0.8rem !Important;">
                                {!! converteValor('MYSQL', 'PTBR', $fundoResumoMunicipio->prc_inadiplencia_2024) . '%' !!}
                            </th>
                        </tr>
                ...
                <table class="table table-sm table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th class="borda_table_indicadores text-right font-numero"
                                style="width: 32.65%; font-size: 0.8rem !Important;">
                                {!! formatarNumeroInteiro($fundoResumoMunicipio->num_quantidade_contratos_2023) !!}
                            </th>
                            <th class="borda_table_indicadores text-right font-numero"
                                style="width: 32.65%; font-size: 0.8rem !Important;">
                                {!! prettify_numbers($fundoResumoMunicipio->vlr_contratado_2023) !!}
                            </th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <th class="borda_table_indicadores text-right font-numero"
                                style="font-size: 0.8rem !Important;">
                                {!! formatarNumeroInteiro($fundoResumoMunicipio->num_quantidade_contratos_2024) !!}
                            </th>
                            <th class="borda_table_indicadores text-right font-numero"
                                style="font-size: 0.8rem !Important;">
                                {!! prettify_numbers($fundoResumoMunicipio->vlr_contratado_2024) !!}
                            </th>
                        </tr>
                ...
                <table class="table table-sm table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th class="borda_table_indicadores text-right font-numero"
                                style="width: 32.65%; font-size: 0.8rem !Important;">
                                {!! formatarNumeroInteiro($fundoResumoMunicipio->num_quantidade_desembolso_2023) !!}
                            </th>
                            <th class="borda_table_indicadores text-right font-numero"
                                style="width: 32.65%; font-size: 0.8rem !Important;">
                                {!! prettify_numbers($fundoResumoMunicipio->vlr_desembolsado_2023) !!}
                            </th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <th class="borda_table_indicadores text-right font-numero"
                                style="font-size: 0.8rem !Important;">
                                {!! formatarNumeroInteiro($fundoResumoMunicipio->num_quantidade_desembolso_2024) !!}
                            </th>
                            <th class="borda_table_indicadores text-right font-numero"
                                style="font-size: 0.8rem !Important;">
                                {!! prettify_numbers($fundoResumoMunicipio->vlr_desembolsado_2024) !!}
                            </th>
                        </tr>
