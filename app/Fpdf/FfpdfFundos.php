...
class FfpdfFundos extends Fpdf
{
    ...
    function Header()
    {
        ...
        //Move to the right
        $this->Image(public_path() . '/img/cabecalho_landscape_fundos.jpg', 14, 5, 275, 19); // (0 = left, 0 = top, 0 = largura Imagem, 0 = altura Imagem)
        $this->SetXY(15, 6);
    ...
    function Footer() {
        ...
        $this->Cell(90, 0, "_________________________________________________________________________________________________________________________________________________________________________________________________________________________________________", 0, 0, 'L');
        ...
        $this->SetXY(99, -10);
        $this->SetFont('Arial', 'I', 8);
        $this->Cell(190, 5, utf8_decode('página ') . $this->PageNo(), '', 0, 'R');
    }
