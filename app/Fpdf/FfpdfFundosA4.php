...
class FfpdfFundos extends Fpdf
{
    ...
    function Header()
    {
        ...
        //Move to the right
        $this->Image(public_path() . '/img/cabecalho_fundos.jpg', 9, 5, 195, 18); // (0 = left, 0 = top, 0 = largura Imagem, 0 = altura Imagem)
        $this->SetXY(15, 6);
    ...
    function Footer() {
        ...
        $this->Cell(90, 0, "_____________________________________________________________________________________________________________________________________________________________________", 0, 0, 'L');
